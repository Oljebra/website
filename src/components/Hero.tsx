      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Oljebra Group builds cutting-edge technology solutions that streamline your business processes, increase efficiency, and drive sustainable
            growth. Let us help you unlock your business potential.
          </p>
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            ...
            <div className="text-gray-600">Process Efficiency Improvement</div>
          </div>
          <div className="text-center">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
            ...
            <p className="text-gray-600 text-sm">Quick deployment with minimal disruption to your operations</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
            ...
            <p className="text-gray-600 text-sm">Track record of successful business transformations</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
            ...
            <p className="text-gray-600 text-sm">Technology that grows with your business needs</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
            ...
            <p className="text-gray-600 text-sm">Dedicated team of technology specialists</p>
          </div>
        </div>
      </div>
    </section>
