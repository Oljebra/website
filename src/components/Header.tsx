      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex-shrink-0">
            <Link href="/" className="flex items-center bg-white px-3 py-1 rounded-lg">
              <Image src="/logo.png" alt="Oljebra Group" width={120} height={40} className="h-8 w-auto" priority />
            </Link>
          </div>
